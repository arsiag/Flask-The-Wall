...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `fk_comments_messages1` FOREIGN KEY (`message_id`) REFERENCES `messages` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
-- Dump completed on 2017-09-16 10:04:52
